...
asyncio::task::Task<void, std::error_code> handle(asyncio::net::ssl::Buffer buffer) {
...
asyncio::task::Task<void, std::error_code> serve(asyncio::net::ssl::Listener listener) {
